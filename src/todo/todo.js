...
function todoView(todo) {
    ...
    editPriorityBtn.textContent = 'Change priority';
    ...
    view.appendChild(editPriorityBtn);
...
function projectView(project) {
    ...
    addTodoBtn.addEventListener('click', () => {
        ...
        const todo = Todo(todoTitle, todoDescription, new Date(), todoPriority, project.title);
